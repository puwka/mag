...
async function upsertSettings() {
  const rows = [
    ...
    { key: "contacts.telegram", value: "", label: "Telegram", group_name: "contacts", is_public: true },
    { key: "contacts.max", value: "", label: "MAX", group_name: "contacts", is_public: true },
    { key: "contacts.telegram_label", value: "Telegram", label: "Подпись Telegram", group_name: "contacts", is_public: true },
    { key: "contacts.max_label", value: "MAX", label: "Подпись MAX", group_name: "contacts", is_public: true },
